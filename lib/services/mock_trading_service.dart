  ...
  static List<TradingBot> getMockBots() {
    return [
      ...
      TradingBot(
        id: '4',
        name: 'Sniper-V2',
        strategyName: 'Breakout Scalp',
        marketSymbol: 'LINK/USDT',
        status: 'STOPPED',
        netProfit: 210.00,
        allocation: 1000.0,
        runtime: '1d 12h',
  ...
  static List<LogEntry> getMockLogs() {
    return [
      LogEntry(
        ...
        type: 'EXECUTION',
        source: 'Alpha-Grid-01',
        message: 'Order filled: BUY 0.01 BTC at 96350.20',
      ),
      LogEntry(
        id: 'l2',
        ...
        type: 'INFO',
        source: 'ENGINE',
        message: 'Risk manager heart-beat check: OK',
      ),
      LogEntry(
        id: 'l3',
        timestamp: DateTime.now().subtract(const Duration(minutes: 5)),
        type: 'WARNING',
        source: 'BROKER_API',
        message: 'Latency increased to 150ms on Binance Stream',
      ),
      LogEntry(
        id: 'l4',
        ...
        type: 'ERROR',
        source: 'BOT_02',
        message: 'Strategy execution failed: insufficient margin',
      ),
    ];
  }
}
