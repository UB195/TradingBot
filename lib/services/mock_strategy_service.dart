  ...
  static List<StrategyConfig> getMockStrategies() {
    ...
    return [
      StrategyConfig(
        ...
        description:
            'Exploits mathematical pricing imbalances across correlated token clusters.',
        market: 'Crypto',
        instrument: 'BTC/USDT',
        timeframe: '15m',
        version: 'v2.1.0',
      ...
      StrategyConfig(
        ...
        description:
            'Predicts high-probability trend breakouts using sequential pattern history.',
        market: 'Crypto',
        instrument: 'ETH/USDT',
        timeframe: '1H',
        version: 'v1.4.2',
        ...
        advanced: const AdvancedRiskConfig(
          positionSizingMethod: 'Risk-Per-Trade Based',
          positionSizingValue: 1.2,
          riskPerTradePercent: 1.2,
          maxTradesPerDay: 3,
          maxDailyLossPercent: 4.0,
          tradingSession: 'US Session (13:30 - 20:00 UTC)',
          cooldownMinutes: 45,
        ),
      ),
      StrategyConfig(
        ...
        description:
            'Places structural buy/sell grids to secure delta-neutral execution profits.',
        market: 'Crypto',
        instrument: 'SOL/USDT',
        timeframe: '5m',
        version: 'v3.0.1',
        ...
        advanced: const AdvancedRiskConfig(
          positionSizingMethod: 'Fixed Amount',
          positionSizingValue: 2500.0,
    ...
    return {
      alpha.id: [
        StrategyVersion(
          ...
          changeNote:
              'Tightened ATR volatility ceiling and reduced per-trade risk to 0.8%.',
          snapshot: alpha,
        ),
        StrategyVersion(
          version: 'v2.0.0',
          ...
          changeNote:
              'Added Range-Bound market regime filter to avoid trend-driven false signals.',
          snapshot: alpha,
        ),
        StrategyVersion(
          version: 'v1.1.0',
          ...
          changeNote:
              'Initial production release with RSI oversold + lower Bollinger Band entry.',
          snapshot: alpha,
        ),
      ],
      lstm.id: [
        StrategyVersion(
          ...
          changeNote:
              'Switched volume filter threshold to 1.5× average volume.',
          snapshot: lstm,
        ),
        StrategyVersion(
          version: 'v1.2.0',
          ...
          changeNote:
              'Replaced SMA(50) trend filter with EMA cross confirmation.',
          snapshot: lstm,
        ),
      ],
      grid.id: [
        StrategyVersion(
          ...
          changeNote:
              'Added Open Interest OR-condition to capture derivatives-driven breakouts.',
          snapshot: grid,
        ),
        StrategyVersion(
          version: 'v2.4.0',
          ...
          changeNote:
              'Reduced grid step and cooldown to improve fill frequency.',
          snapshot: grid,
        ),
      ],
    };
